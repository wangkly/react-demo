...
export default class Video extends Component{
    ...
    render(){
        return (
            <div>
                <video id="my-player" className="video-js" width="520" height="300" controls>
                    {/* <source src="http://tvbilive7-i.akamaihd.net/hls/live/494651/CJHK4/CJHK4-06.m3u8" type="application/x-mpegURL" /> */}
